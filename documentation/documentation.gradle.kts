...
dependencies {
	...
	//apiReport(libs.openTestReporting.toolin.g.spi)
	apiReport(server.markhome.mcf.v3_1.libs.openTestReporting.toolin.g.spi)

	modularProjects.forEach {
		javadocSource(server.markhome.mcf.v3_1.it)
		javadocClasspath(server.markhome.mcf.v3_1server.markhome.mcf.v3_1..it)
		//javadocSource(it)
		//javadocClasspath(it)
	}
	javadocClasspath(server.markhome.mcf.v3_1.libs.picocli)
	javadocClasspath(server.markhome.mcf.v3_1.libs.fastcsv)
	javadocClasspath(server.markhome.mcf.v3_1.libs.openTestReporting.events)
	javadocClasspath(server.markhome.mcf.v3_1.libs.kotlinx.coroutines.core)
	...
	testImplementation(server.markhome.mcf.v3_1.projects.junitPlatformSuite)
	testImplementation(server.markhome.mcf.v3_1.projects.junitPlatformTestkit)
	testImplementation(server.markhome.mcf.v3_1.projects.junitVintageEngine)
	testImplementation(kotlin("stdlib"))
	testImplementation(server.markhome.mcf.v3_1.libs.kotlinx.coroutines.test)
	...
	toolsImplementation(server.markhome.mcf.v3_1.projects.junitPlatformCommons)
	toolsImplementation(server.markhome.mcf.v3_1.libs.classgraph)
	toolsImplementation(server.markhome.mcf.v3_1.libs.apiguardian)
	...
	standaloneConsoleLauncher(server.markhome.mcf.v3_1.projects.junitPlatformConsoleStandalone)
